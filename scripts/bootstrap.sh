...
mkdir -p "$skills_home"
mkdir -p "$learning_home/learning-records" "$learning_home/sessions" "$learning_home/reference"

skills="ai-native-task-tutor teach diagnosing-bugs"
...
for template_path in "$repo_root"/learning-profile-template/*.md; do
  template_name="$(basename -- "$template_path")"
  profile_path="$learning_home/$template_name"
